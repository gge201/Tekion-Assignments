...
import com.example.CricketMatch.Services.InningsService;

public class Match {

    private String kk;
    private InningsService I1,I2;
    private String toss;
    ...
    public void setWinIndicator(int winIndicator) {
...
//    }
    ...
    public InningsService getI1() {
        return I1;
    }

    public InningsService getI2() {
        return I2;
    }
...
//        team1Name=Team1;
//        team2Name=Team2;
        I1=new InningsService();
        I2=new InningsService();
        this.totalOvers = overs;
        team1 = new Team(Team1);
        team2 = new Team(Team2);
        team1.P[0].setRating(9);
        team1.P[0].setType("Batsman");
        team1.P[1].setRating(8.5f);
        team1.P[1].setType("Batsman");
        team1.P[2].setRating(9.5f);
        team1.P[2].setType("Batsman");
        team1.P[3].setRating(8);
        team1.P[3].setType("Batsman");
        team1.P[4].setRating(8);
        team1.P[4].setType("Batsman");
        team1.P[5].setRating(7.5f);
        team1.P[5].setType("Batsman");
        team1.P[6].setRating(8.5f);
        team1.P[6].setType("Bowler");
        team1.P[7].setRating(8);
        team1.P[7].setType("Bowler");
        team1.P[8].setRating(9);
        team1.P[8].setType("Bowler");
        team1.P[9].setRating(7);
        team1.P[9].setType("Bowler");
        team1.P[10].setRating(9);
        team1.P[10].setType("Bowler");

        team2.P[0].setRating(9.5f);
        team2.P[0].setType("Batsman");
        team2.P[1].setRating(8.5f);
        team2.P[1].setType("Batsman");
        team2.P[2].setRating(9f);
        team2.P[2].setType("Batsman");
        team2.P[3].setRating(8.5f);
        team2.P[3].setType("Batsman");
        team2.P[4].setRating(8.5f);
        team2.P[4].setType("Batsman");
        team2.P[5].setRating(7.5f);
        team2.P[5].setType("Batsman");
        team2.P[6].setRating(9);
        team2.P[6].setType("Bowler");
        team2.P[7].setRating(8.5f);
        team2.P[7].setType("Bowler");
        team2.P[8].setRating(9);
        team2.P[8].setType("Bowler");
        team2.P[9].setRating(7.5f);
        team2.P[9].setType("Bowler");
        team2.P[10].setRating(9);
        team2.P[10].setType("Bowler");
    }
...
//        I2.playInnings(totalOvers,I1.getInnings().getScore(),team2.P,team1.P);
//
//
//        decider=I1.getInnings().getScore()-I2.getInnings().getScore();
...
//        if(I1.getInnings().getScore()==I2.getInnings().getScore())
//        {
//            Result = "Verdict --  Match Tied";
//            winIndicator =0;
//        }
//        if(I2.getInnings().getScore()>I1.getInnings().getScore())
//        {
//            winIndicator =2;
//            decider=10-I2.getInnings().getWickets();
//            winBy="wickets";
//        }
//        if(winIndicator ==1) {
//            Result = "Verdict --  " + team1.getTeamName() + " won by " + decider + " " + winBy + " ( " + I2.getInnings().getBallsLeft() + " balls left )";
//        }
//        else if(winIndicator ==2){
//            Result = "Verdict --  " + team2.getTeamName() + " won by " + decider + " " + winBy + " ( " + I2.getInnings().getBallsLeft() + " balls left )";
//        }
//        jj[4]=jj[4]+"<br>";
